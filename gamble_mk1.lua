...
function _gamble(tdArray, rParam, logs)
  ...
  for i = 1, #tdArray, 1 do
    ...
    if bignum.compare(modGNumber, bignum.number(belowNum)) == -1 then
      ...
      contract.event("gamble", tdArray, rParam, gNumber, modGNumber, belowNum, groupId, logs)
      return groupId
    end
  end
